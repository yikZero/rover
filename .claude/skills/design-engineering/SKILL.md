...
description: UI polish, animation decisions, easing/timing, component interaction design, and the invisible details that make interfaces feel great. Use this skill when working on animations, transitions, hover effects, drawers, modals, toasts, popovers, drag interactions, or any UI that needs to feel responsive and polished.
---
